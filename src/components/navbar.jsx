...
function Navbar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-72 bg-gradient-to-b from-red-700 via-red-600 to-red-800 text-white shadow-2xl flex flex-col z-50 overflow-hidden">
